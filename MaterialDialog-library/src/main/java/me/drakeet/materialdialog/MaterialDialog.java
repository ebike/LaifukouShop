...
public class MaterialDialog {
    ...
    public MaterialDialog setMessageVisiale(int visiale) {
        if (mBuilder != null) {
            mBuilder.setMessageVisiale(visiale);
        }
        return this;
    }
    ...
    private class Builder {
        ...
        public void setMessageVisiale(int visiale) {
            mMessageView.setVisibility(visiale);
        }
...
//                linearLayout.removeAllViews();
                linearLayout.addView(contentView, linearLayout.getChildCount());
            }
