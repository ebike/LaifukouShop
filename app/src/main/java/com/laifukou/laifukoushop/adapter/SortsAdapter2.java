...
import com.laifukou.laifukoushop.common.util.ScreenUtils;
 ...
 * 热门分类（下）
 */
public class SortsAdapter2 extends TAdapter<HomePageDataItemModel> {

    public SortsAdapter2(Context mContext) {
        super(mContext);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.adapter_sorts2, parent, false);
        }
